...
public class PredictedMetadata_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (PredictedMetadata_Type.this.useExistingInstance) {
        // Return eq fs instance if already created
        FeatureStructure fs = PredictedMetadata_Type.this.jcas.getJfsFromCaddr(addr);
        if (null == fs) {
          fs = new PredictedMetadata(addr, PredictedMetadata_Type.this);
          PredictedMetadata_Type.this.jcas.putJfsFromCaddr(addr, fs);
          return fs;
        }
        return fs;
      } else {
        return new PredictedMetadata(addr, PredictedMetadata_Type.this);
      }
    }
  };
  /** @generated */
  ...
  public final static boolean featOkTst =
      JCasRegistry.getFeatOkTst("lu.svv.saa.linklaters.privacypolicies.type.PredictedMetadata");
  ...
  public String getMetadata1(int addr) {
    if (featOkTst && casFeat_metadata1 == null) {
      jcas.throwFeatMissing("metadata1", "lu.svv.saa.linklaters.privacypolicies.type.PredictedMetadata");
    }
  ...
  public String getMetadata2(int addr) {
    if (featOkTst && casFeat_metadata2 == null) {
      jcas.throwFeatMissing("metadata2", "lu.svv.saa.linklaters.privacypolicies.type.PredictedMetadata");
    }
  ...
  public String getMetadata3(int addr) {
    if (featOkTst && casFeat_metadata3 == null) {
      jcas.throwFeatMissing("metadata3", "lu.svv.saa.linklaters.privacypolicies.type.PredictedMetadata");
    }
  ...
  public String getMetadata4(int addr) {
    if (featOkTst && casFeat_metadata4 == null) {
      jcas.throwFeatMissing("metadata4", "lu.svv.saa.linklaters.privacypolicies.type.PredictedMetadata");
    }
  ...
  public String getKeywords(int addr) {
    if (featOkTst && casFeat_keywords == null) {
      jcas.throwFeatMissing("keywords", "lu.svv.saa.linklaters.privacypolicies.type.PredictedMetadata");
    }
  ...
  public String getValue(int addr) {
    if (featOkTst && casFeat_value == null) {
      jcas.throwFeatMissing("value", "lu.svv.saa.linklaters.privacypolicies.type.PredictedMetadata");
    }
